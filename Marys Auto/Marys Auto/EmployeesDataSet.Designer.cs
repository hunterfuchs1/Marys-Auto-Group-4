...
namespace Marys_Auto.EmployeesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([Employee_ID] = @Original_Employee_ID) AND ([EmployeeFirstName] = @Original_EmployeeFirstName) AND ([EmployeeLastName] = @Original_EmployeeLastName) AND ((@IsNull_JobTitle = 1 AND [JobTitle] IS NULL) OR ([JobTitle] = @Original_JobTitle)) AND ((@IsNull_HourlyWage = 1 AND [HourlyWage] IS NULL) OR ([HourlyWage] = @Original_HourlyWage)) AND ((@IsNull_Experience = 1 AND [Experience] IS NULL) OR ([Experience] = @Original_Experience)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_HourlyWage", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "HourlyWage", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([EmployeeFirstName], [EmployeeLastName], [JobTitle], [HourlyWage], [Experience]) VALUES (@EmployeeFirstName, @EmployeeLastName, @JobTitle, @HourlyWage, @Experience);
SELECT Employee_ID, EmployeeFirstName, EmployeeLastName, JobTitle, HourlyWage, Experience FROM Employees WHERE (Employee_ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [EmployeeFirstName] = @EmployeeFirstName, [EmployeeLastName] = @EmployeeLastName, [JobTitle] = @JobTitle, [HourlyWage] = @HourlyWage, [Experience] = @Experience WHERE (([Employee_ID] = @Original_Employee_ID) AND ([EmployeeFirstName] = @Original_EmployeeFirstName) AND ([EmployeeLastName] = @Original_EmployeeLastName) AND ((@IsNull_JobTitle = 1 AND [JobTitle] IS NULL) OR ([JobTitle] = @Original_JobTitle)) AND ((@IsNull_HourlyWage = 1 AND [HourlyWage] IS NULL) OR ([HourlyWage] = @Original_HourlyWage)) AND ((@IsNull_Experience = 1 AND [Experience] IS NULL) OR ([Experience] = @Original_Experience)));
SELECT Employee_ID, EmployeeFirstName, EmployeeLastName, JobTitle, HourlyWage, Experience FROM Employees WHERE (Employee_ID = @Employee_ID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@HourlyWage", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "HourlyWage", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_HourlyWage", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "HourlyWage", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Employee_ID, EmployeeFirstName, EmployeeLastName, JobTitle, HourlyWage, Ex" +
                "perience FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_Employee_ID, string Original_EmployeeFirstName, string Original_EmployeeLastName, string Original_JobTitle, global::System.Nullable<decimal> Original_HourlyWage, global::System.Nullable<int> Original_Experience) {
        ...
        public virtual int Update(string EmployeeFirstName, string EmployeeLastName, string JobTitle, global::System.Nullable<decimal> HourlyWage, global::System.Nullable<int> Experience, int Original_Employee_ID, string Original_EmployeeFirstName, string Original_EmployeeLastName, string Original_JobTitle, global::System.Nullable<decimal> Original_HourlyWage, global::System.Nullable<int> Original_Experience, int Employee_ID) {
            if ((EmployeeFirstName == null)) {
                throw new global::System.ArgumentNullException("EmployeeFirstName");
            }
            else {
            ...
            if ((HourlyWage.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((decimal)(HourlyWage.Value));
            }
            else {
            ...
            if ((Original_EmployeeFirstName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_EmployeeFirstName));
            }
            if ((Original_EmployeeLastName == null)) {
                throw new global::System.ArgumentNullException("Original_EmployeeLastName");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_EmployeeLastName));
            }
            if ((Original_JobTitle == null)) {
            ...
            if ((Original_HourlyWage.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((decimal)(Original_HourlyWage.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string EmployeeFirstName, string EmployeeLastName, string JobTitle, global::System.Nullable<decimal> HourlyWage, global::System.Nullable<int> Experience, int Original_Employee_ID, string Original_EmployeeFirstName, string Original_EmployeeLastName, string Original_JobTitle, global::System.Nullable<decimal> Original_HourlyWage, global::System.Nullable<int> Original_Experience) {
            return this.Update(EmployeeFirstName, EmployeeLastName, JobTitle, HourlyWage, Experience, Original_Employee_ID, Original_EmployeeFirstName, Original_EmployeeLastName, Original_JobTitle, Original_HourlyWage, Original_Experience, Original_Employee_ID);
        }
    }
